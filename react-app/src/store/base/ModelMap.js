 ...
 *
 *  it behaves like a collection map
 *
 ...
 *
 */
export default class ModelMap extends Field {
  modelClass;
  isModelCollection = true;
  initialValue: Array<*> = [];
  constructor(model, fieldName, options) {
    options.type = FieldType.modelMap;
  ...
  @override initValue(collectionValues) {
